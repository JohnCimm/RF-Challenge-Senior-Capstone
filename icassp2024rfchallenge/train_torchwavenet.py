...
def main(argv: List[str]):
    ...
    parser.add_argument("--config", type=str, default="/uufs/chpc.utah.edu/common/home/u1110463/icassp2024rfchallenge/src/configs/wavenet.yml",
    ...
    cfg.data.root_dir = f"/scratch/general/vast/u1110463/npydataset/Dataset_{sigtype}_Mixture"
