...
#os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "/uufs/chpc.utah.edu"
import glob
import h5py
import numpy as np
...
class DatasetQpskCommsignal2Mixture(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager: tfds.download.DownloadManager):
        ...
        path = os.path.join('/scratch/general/vast/u1110463/dataset', f'Dataset_{soi_type}_{interference_sig_type}_Mixture')
